...
public class Password {
    ...
    private static final int saltLen = 16;  // can be 32
    private static final int desiredKeyLen = 64; //can be 256
...
/* use example
 * 
 * String getSaltedHash(char[] password)
 * boolean checkPassword(char[] password, String stored)
 * 
 */
